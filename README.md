...
- `/lucky` (или `/find`) — случайная горячая «находка» + мини-график реакций по категориям
...
- Reply-кнопки: Сводка / Только новое / 🎲 Находка / Источники / Темы / Расписание / Меню / Помощь
- `/menu` — inline-меню: выбор режима сводки, находка, источники, темы, расписание
