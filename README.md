...
- `/news flash` — экспресс: топ-5 по реакциям + пульс категорий (одна страница)
...
- Reply-кнопки: Сводка / ⚡ Экспресс / Только новое / Источники / Темы / Расписание / Меню / Помощь
- `/menu` — inline-меню: выбор режима сводки (экспресс / полное / только новое), источники, темы, расписание
