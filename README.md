...
Telegram-бот **SEO-дайджеста** из ваших публичных Telegram-каналов и RSS-лент: без дублей, рекламы и оффтопа.

Работает в **личке и в групповых чатах**. У каждого чата свои каналы/ленты, темы и расписание; в группе настраивать могут администраторы.

`/news` собирает новости за период, раскладывает по блокам (Google / линкбилдинг / инструменты / аналитика / ИИ / контент), пишет выжимку из 2 предложений и сортирует по реакциям/новизне.

Источники:
- Публичные Telegram-каналы (`@channel` / `https://t.me/channel` / папка `t.me/addlist/…`). Читаем через публичный превью `t.me/s/...`.
- RSS/Atom ленты (`/add rss https://site.com/feed/` или URL ленты).
- Готовые наборы в меню: **SEO / iGaming (Telegram)** и **SEO Блоги (RSS)** (Ahrefs, Backlinko, Moz, SEJ, SEL, Semrush, Google Search Central, Screaming Frog, Aleyda Solis, Marie Haynes).

## Команды

- `/start`, `/help` — справка
- `/add @channel [название]` — добавить Telegram-канал
- `/add rss <url_ленты> [название]` — добавить RSS-ленту
